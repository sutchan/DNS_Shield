...
[![English](https://img.shields.io/badge/language-English-blue)](README.en.md) [![中文](https://img.shields.io/badge/language-中文-red)](README.md) [![Version](https://img.shields.io/badge/version-3.4.0-green)](https://github.com/sutchan/DNS_Shield)
...
- **Next.js framework** - v3.4.0 version has migrated to modern Next.js framework and modular architecture
