...
[![English](https://img.shields.io/badge/language-English-blue)](README.en.md) [![中文](https://img.shields.io/badge/language-中文-red)](README.md) [![Version](https://img.shields.io/badge/version-2.3.2-green)](https://github.com/sutchan/DNS_Shield)
...
- **Next.js framework** - v2.3.2 version has migrated to modern Next.js framework
