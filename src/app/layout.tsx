...
export const metadata: Metadata = {
  ...
  title: {
    default: 'DNS Shield v3.6.0 - 路由器级广告过滤规则生成工具',
    template: '%s | DNS Shield',
  },
  description: 'DNS Shield v3.6.0 - 路由器级全局广告过滤规则生成工具。基于 dnsmasq/hosts 的路由器广告过滤，支持梅林固件、小米路由器、OpenWrt 等设备。自动生成 AdBlock、DNS 过滤规则，轻松屏蔽广告域名。',
  ...
  openGraph: {
    ...
    siteName: 'DNS Shield',
    title: 'DNS Shield v3.6.0 - 路由器级广告过滤规则生成工具',
